...
class OIDCAuthentication {
     ...
     */
    constructor() {
        this.setupAuthn = new OIDCSetupAuthentication(() => this.onSetupPhaseNext());
...
class OIDCAuthenticationResult {
    ...
    displayResult(resultData) {
        ...
        if (resultData.responseParameters) {
            ...
            console.log("MISSING CLAIMS " + resultData.missingIdTokenClaims);
...
class OIDCAuthnRequest {
    ...
    init() {
        ...
        $('#oidc-request-claims-id-add-button').click(function () {
            addClaimFunction('id', idTokenIndex);
            idTokenIndex++;
        });
        $('#oidc-request-claims-userinfo-add-button').click(function () {
            addClaimFunction('userinfo', userInfoIndex);
            userInfoIndex++;
        })
        this.initField(
