...
/**
 * Configuration class for the SAML support.
 *
 * @author Martin Lindström
 */
@ConditionalOnProperty(prefix = "testclient.saml", name = "enabled", havingValue = "true", matchIfMissing = false)
@Configuration
@DependsOn("openSAML")
public class SamlConfiguration {
  ...
  public SamlConfiguration(@Nonnull final SamlProperties properties,
  ...
  EntityDescriptor templateEntityDescriptor() throws Exception {
    final SamlProperties.CommonSpMetadataProperties mp = this.properties.getCommonMetadata();
